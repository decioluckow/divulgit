...
public class BitBucketCommentResponseHandler {
    ...
    public BitBucketComment handle200ResponseSingleResult(ResponseEntity<String> response) throws RemoteException {
        try {
            ...
            return objectMapper.readValue(response.getBody(), BitBucketComment.class);
    ...
    public List<BitBucketComment> handle200ResponseMultipleResult(ResponseEntity<String> response) throws RemoteException {
        try {
