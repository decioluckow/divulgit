...
class AzureThreadResponseHandlerTest {
    ...
    public void testMultipleResponse() throws IOException, RemoteException {
        ...
        assertEquals("1", azureComment0.getId());
        ...
        assertEquals("1", azureComment1.getId());
        ...
        assertEquals("1", azureComment2.getId());
        ...
        assertEquals("1", azureComment3.getId());
        ...
        assertEquals("1", azureComment4.getId());
